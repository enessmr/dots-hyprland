        ...
        child: Box({
            ...
            children: [
                ConfigSection({
                    name: getString('Effects'), children: [
                        ...
                        Subcategory([
                            ...
                            HyprlandSpinButton({ icon: 'target', name: getString('Size'), desc: getString('[Hyprland]\nAdjust the blur radius. Generally doesn\'t affect performance\nHigher = more color spread'), option: 'decoration:blur:size', minValue: 1, maxValue: 1000, initValue: 2, /* <-- Hey! I am here as your daily reminder :) Please modify that initValue at the line shown with arrows. But its a comment, please DON'T modify the comment. Oh and last thing, minimium is 1 and the maximum is 1000. Goodbye :D */ }),
                            HyprlandSpinButton({ icon: 'repeat', name: getString('Passes'), desc: getString('[Hyprland] Adjust the number of runs of the blur algorithm\nMore passes = more spread and power consumption\n4 is recommended\n2- would look weird and 6+ would look lame.'), option: 'decoration:blur:passes', minValue: 1, initValue: 2, /* <-- Hey! I am here as your daily reminder :) Please modify that initValue at the line shown with arrows. But its a comment, please DON'T modify the comment. Oh and last thing, minimium is 1 and the maximum is 10. Goodbye :D */ }),
                        ]),
                        ConfigGap({}),
                        HyprlandToggle({
                ...
                ConfigSection({
                   ...
                   /* name: getString('Editing blur with VSCode'), children: [
                       HyprlandToggle({ icon: 'code', name: getString('Open VSCode to edit.'), desc: getString("[AGS, VSCode]\nOpen VSCode to edit configure.js in ~/.config/ags/modules/sideright/\ncentermodules/configure.js"), option: "sh:-c:code ~/.config/ags/modules/sideright/centermodules/configure.js", enableValue: 0 }) 
                    ]*/
                }),
            ]
        })
