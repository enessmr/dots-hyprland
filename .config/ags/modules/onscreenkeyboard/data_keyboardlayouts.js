...
export const DEFAULT_OSK_LAYOUT = "qwerty_full_us"
export const oskLayouts = {
    ...
    qwerty_full_trq: {
        "name": "QWERTY - Full - TR (Logitech)",
        "name_short": "TRQ",
        "comment": "Logitech Turkish Q Layout",
        "keys": [
            [
                { "keytype": "normal", "label": "Esc", "shape": "fn", "keycode": 1 },
                { "keytype": "normal", "label": "F1", "shape": "fn", "keycode": 59 },
            ...
            [
                ...
                { "keytype": "normal", "label": "-", "labelShift": "_", "shape": "normal", "keycode": 13 },
                { "keytype": "normal", "label": "Backspace", "shape": "expand", "keycode": 14 }
            ],
            [
                { "keytype": "normal", "label": "Tab", "shape": "tab", "keycode": 15 },
                ...
                { "keytype": "normal", "label": "y", "labelShift": "Y", "shape": "normal", "keycode": 21 },
                { "keytype": "normal", "label": "u", "labelShift": "U", "shape": "normal", "keycode": 22 },
                { "keytype": "normal", "label": "ı", "labelShift": "I", "shape": "normal", "keycode": 23 },
                { "keytype": "normal", "label": "o", "labelShift": "O", "shape": "normal", "keycode": 24 },
                { "keytype": "normal", "label": "p", "labelShift": "P", "shape": "normal", "keycode": 25 },
                { "keytype": "normal", "label": "ğ", "labelShift": "Ğ", "shape": "normal", "keycode": 26 },
                { "keytype": "normal", "label": "ü", "labelShift": "Ü", "shape": "normal", "keycode": 27 },
             //   { "keytype": "normal", "label": "*", "labelShift": "*", "shape": "expand", "keycode": 43 } // Updated for Logitech
            ],
            [
                { "keytype": "normal", "label": "Caps", "shape": "normal", "keycode": 58 }, // Updated for Logitech
                { "keytype": "normal", "label": "a", "labelShift": "A", "shape": "normal", "keycode": 30 },
                { "keytype": "normal", "label": "s", "labelShift": "S", "shape": "normal", "keycode": 31 },
                { "keytype": "normal", "label": "d", "labelShift": "D", "shape": "normal", "keycode": 32 },
                { "keytype": "normal", "label": "f", "labelShift": "F", "shape": "normal", "keycode": 33 },
                ...
                { "keytype": "normal", "label": "k", "labelShift": "K", "shape": "normal", "keycode": 37 },
                { "keytype": "normal", "label": "l", "labelShift": "L", "shape": "normal", "keycode": 38 },
                { "keytype": "normal", "label": "ş", "labelShift": "Ş", "shape": "normal", "keycode": 39 },
                { "keytype": "normal", "label": "i", "labelShift": "İ", "shape": "normal", "keycode": 40 }, // Updated for Logitech
                { "keytype": "normal", "label": "Enter", "shape": "expand", "keycode": 28 }
            ],
            [
                { "keytype": "modkey", "label": "Shift", "labelShift": "Shift ⇧", "labelCaps": "Locked ⇩", "shape": "shift", "keycode": 42 },
                ...
                { "keytype": "normal", "label": "n", "labelShift": "N", "shape": "normal", "keycode": 49 },
                { "keytype": "normal", "label": "m", "labelShift": "M", "shape": "normal", "keycode": 50 },
                { "keytype": "normal", "label": "ö", "labelShift": "Ö", "shape": "normal", "keycode": 51 },
                { "keytype": "normal", "label": "ç", "labelShift": "Ç", "shape": "normal", "keycode": 52 }, // Updated for Logitech
                { "keytype": "normal", "label": ",", "labelShift": ";", "shape": "normal", "keycode": 43 }, // Updated for Logitech
                { "keytype": "normal", "label": ".", "labelShift": ":", "shape": "normal", "keycode": 53 }, // Updated for Logitech
            //  { "keytype": "normal", "label": "/", "labelShift": "?", "shape": "normal", "keycode": 55 } // Why the fuck slash is HERE?????????????
            ],
            [
                { "keytype": "normal", "label": "Ctrl", "shape": "normal", "keycode": 29 },
                { "keytype": "modkey", "label": "Alt", "shape": "normal", "keycode": 56 },
                { "keytype": "modkey", "label": "Space", "shape": "expand", "keycode": 57 },
                { "keytype": "modkey", "label": "Alt", "shape": "normal", "keycode": 100 }, // Updated for Logitech
                { "keytype": "normal", "label": "Ctrl", "shape": "normal", "keycode": 29 }
            ]
        ]
    }
